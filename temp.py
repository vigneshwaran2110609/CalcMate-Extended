...
def solve_equation(equations, distinct_symbols):
    ...
    def format_value(val):
        """Format a value for display, handling complex numbers and rounding near-integers."""
        if hasattr(val, 'is_real') and not val.is_real:
            ...
            # Handle Answer part
                ...
                if "Problem Steps:" in answer_content:
                    ...
                    if "Equations:" in answer_content:
                        ...
                        # Use regex to find equation patterns (number followed by colon)
                        matches = re.finditer(r'(\dss:)', equation_text)
                        ...
                        for eq in equation_items:
                            eq = eq.strip()
                            if eq:
                                # Just display the equation as is - no additional numbering
